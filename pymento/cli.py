...
def parse_args():
    ...
    parser.add_argument('--raw_data_dir', '-r',
    ...
    parser.add_argument('--behav_data_dir', '-b',
    ...
    parser.add_argument('--bids_dir',
                        ...
                        naming conventions""",
                        default=None)
    parser.add_argument('--calfiles_dir', '-c',
    ...
    parser.add_argument('--diagnostics_dir', '-d',
...
def main():
    ...
    print(f'I received the following command line arguments: \n'
          f'Subject: {args.subject}\n'
          f'Raw data directory: {args.raw_data_dir}\n'
          f'Behavioral data directory: {args.behav_data_dir}\n')

    # read in raw data
    raw = ut.read_data_original(directory=args.raw_data_dir,
